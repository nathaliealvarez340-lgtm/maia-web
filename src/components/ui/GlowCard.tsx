...
export function GlowCard({ children, className }: GlowCardProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -6 }}
      className={cn(
        "premium-border group relative overflow-hidden rounded-lg border border-white/10 bg-white/[0.03] p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-xl",
